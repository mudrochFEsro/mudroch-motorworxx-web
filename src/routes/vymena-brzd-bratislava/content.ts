...
export const content: Record<Lang, LandingContent> = {
	...
	hr: {
		...
		faq: [
			...
			{ q: 'Zašto mi škripe ili stružu kočnice?', a: 'Škripanje kočnica najčešće uzrokuju istrošene kočione pločice, čiji indikator istrošenosti upozorava na zamjenu, ili korodirani odnosno izbrazdani kočioni diskovi. Struganje može uzrokovati i nečistoća ili zaglavljena kočiona čeljust. Preporučujemo pregled kočnica – škripanje kočnica obično znači da se bliži zamjena kočionih pločica.' },
