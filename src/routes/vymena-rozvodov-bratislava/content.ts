...
export const content: Record<Lang, LandingContent> = {
	...
	de: {
		...
		whenProse:
			'<p>Das <strong>Zahnriemen-Wechselintervall</strong> gibt der Fahrzeughersteller vor – meist zwischen <strong>60.000 – 180.000 km</strong> oder alle <strong>5 – 7 Jahre</strong>, je nach Modell und Motortyp. Die Steuerung ist ein kritisches Bauteil: Wird sie vernachlässigt, kann der Zahnriemen reißen – oder eine Steuerkette sich dehnen und überspringen – und teure Motorschäden verursachen.</p><p>Wenn Sie nicht wissen, wann der Zahnriemen zuletzt gewechselt wurde, oder ein Gebrauchtwagen kaufen, lassen Sie lieber eine <strong>Kontrolle und Motordiagnose</strong> durchführen. Bei MUDROCH MOTORWORXX in Bratislava beurteilen wir den Zustand Ihrer Steuerung und empfehlen einen Wechseltermin.</p>',
		...
		faq: [
			...
			{ q: 'Zahnriemen oder Steuerkette – was ist der Unterschied?', a: 'Ein Zahnriemen besteht aus Gummi und muss im vom Hersteller vorgegebenen Intervall gewechselt werden, meist zusammen mit Wasserpumpe, Umlenkrollen und Spanner. Eine Steuerkette ist aus Metall und hält in der Regel länger, ist aber nicht wartungsfrei – mit der Zeit dehnt sie sich, Spanner und Führungen verschleißen, und eine vernachlässigte Kette kann überspringen und den Motor beschädigen. Bei MUDROCH MOTORWORXX betreuen wir beide Arten der Steuerung komplett.' },
