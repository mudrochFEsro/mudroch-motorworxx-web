<script lang="ts">
	...
	const pageUrl = `${SITE_URL}/autoservis-vrakuna`;
	...
	const keywords =
		'autoservis Vrakuňa, servis áut Vrakuňa, autoservis Bratislava Vrakuňa, autoopravovňa Vrakuňa, autoservis blízko Vrakune';

	const schemas = jsonLd(
		autoRepairSchema(),
		serviceSchema({
			name: 'Autoservis Vrakuňa',
