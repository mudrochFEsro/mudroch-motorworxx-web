<script lang="ts">
	...
	const pageUrl = `${SITE_URL}/autoservis-podunajske-biskupice`;
	...
	const keywords =
		'autoservis Podunajské Biskupice, servis áut Podunajské Biskupice, autoservis Bratislava Podunajské Biskupice, autoservis Závodná, autoopravovňa Podunajské Biskupice';

	const schemas = jsonLd(
		autoRepairSchema(),
		serviceSchema({
			name: 'Autoservis Podunajské Biskupice',
