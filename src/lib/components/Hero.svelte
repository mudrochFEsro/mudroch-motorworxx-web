...
<section class="hero" id="hero" bind:this={heroSection}>
	...
	<div class="container hero-content">
		...
		<figure class="hero-logo" bind:this={logoElement}>
			<img src="/logo.svg" alt="MUDROCH MOTORWORXX - Profesionálny mobilný autoservis v Bratislave" width="214" height="178" fetchpriority="high" />
		</figure>
		...
		<div class="hero-cta" bind:this={ctaElement}>
			<a href="tel:+421944122224" class="btn btn-primary">
				...
				<span><nobr>{$t('hero.phone')}</nobr></span>
			</a>
		</div>
	</div>
</section>
